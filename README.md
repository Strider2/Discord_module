...
2) In phpmyadmin import the phpvms_strider.sql/update_strider.sql file into your database where the main phpvms is located.

3) Import the phpvms_discord.sql in phpmyadmin on your server.
